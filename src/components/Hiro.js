...
function FeaturedVideo({ src, badge, badgeClass, description, to }) {
            ...
            <div className="relative">
                <div className="relative rounded-2xl overflow-hidden border border-slate-200 bg-white shadow-lg">
                    ...
                    <div className="absolute top-4 left-4">
                        <span className={`px-3 py-1.5 text-white rounded-full text-xs font-semibold uppercase tracking-wider shadow ${badgeClass}`}>
                            {badge}
                        </span>
                    </div>
                </div>
            ...
            <div id="home" className="flex w-full min-h-screen flex-col lg:flex-row gap-10 lg:gap-16 items-center justify-center text-slate-900 relative pt-20">
                ...
                <div className='lg:w-1/2 flex justify-center items-center order-1 lg:order-2'>
                    <div className="relative w-full max-w-lg flex flex-col gap-10">
                        {/* "Check This Out" Heading - Above Videos */}
                        <h3 className="text-2xl md:text-3xl font-bold text-center text-slate-900">
                            Check This Out!
                        </h3>
                        ...
                        <FeaturedVideo
                            ...
                            description="80% of the frames in this video are not real."
                            to="/hyperraft"
                        />
                        ...
                        <FeaturedVideo
                            ...
                            description="No instructions or training, this walk emerges from a real scanned brain."
                            to="/fruitfly"
                        />
                    </div>
                </div>
