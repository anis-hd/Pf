...
export default function Modal({ project, onClose }) {
    ...
    return (
        ...
        >
            {/* The Modal itself */}
            <div 
                className="bg-dark-200 rounded-lg shadow-2xl w-full max-w-6xl max-h-[90vh] flex flex-col md:flex-row overflow-hidden"
            ...
            >
                ...
                <div className="md:w-1/2 w-full p-8 flex flex-col">
                    ...
                    <div className="mt-6 pt-4 border-t border-gray-700 flex-shrink-0 flex justify-between items-center">
                        <div>
                          {project.liveLink && (
                              <a href={project.liveLink} target="_blank" rel="noopener noreferrer" className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded transition-colors duration-300">
                                  Live Demo
                              </a>
                          )}
                        </div>
