export default function ExpCard(props) {
    return (
        ...
        <div data-aos="fade-up" data-aos-duration="500" data-aos-offset="0" className="w-full bg-dark-100 rounded-md py-4 px-4 flex items-start">
            
            {/* Image on the left */}
            <img src={props.img} className="w-20 max-h-20 mr-4 rounded-md flex-shrink-0" alt={props.name} />
